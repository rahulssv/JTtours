...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http)throws Exception {
		...
		.requestMatchers("/batches/{tourId}/startDate").permitAll()
		.requestMatchers("/batches/{tourId}/availableSeats").permitAll()
		.requestMatchers("/batches/{tourId}/perParticipantCost").permitAll()
