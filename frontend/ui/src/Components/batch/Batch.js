  ...
  return (
    ...
    >
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        {/* <Button
          style={{ backgroundColor: "#003D59", color: "#FFFFFF",outline:'none',border:0,margin:'auto' }}
          type="submit"
          className="mt-4"
        >
          Book Now
        ...
        <Link
          className="btn btn-primary btn-sm ms-1 mt-4"
          style={{
          ...
          state={{ batchDetails: batchDetails, user: user }}
          to={{
            pathname: `/tours/${batchData?.tour?.id}/bookTour`,
          }}
        >
          Book Now
        </Link>
